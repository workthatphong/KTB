...
import { buildAverageTransitionTimeData } from '@/features/dashboard/utils/transitionMetrics';

import { EditDataBubbleChart } from '@/features/charts/EditDataBubbleChart';
import { SheetBreakdownChart } from '@/features/charts/SheetBreakdownChart';

import { TimelineDetailView } from './expanded-views/TimelineDetailView';
import { UserShareDetailView } from './expanded-views/UserShareDetailView';
import { UserBreakdownDetailView } from './expanded-views/UserBreakdownDetailView';
import { TimeBreakdownDetailView } from './expanded-views/TimeBreakdownDetailView';
import { TransitionBreakdownDetailView } from './expanded-views/TransitionBreakdownDetailView';
import { KpiBreakdownView } from './expanded-views/KpiBreakdownView';

import { ExpandedChartFallback } from './expanded-modal-utils/ExpandedChartFallback';
import { getModalTitle, getModalSubtitle } from './expanded-modal-utils/modalContentHelpers';
import { useSheetPerformanceData } from './expanded-modal-utils/useSheetPerformanceData';
import { useProcessBreakdownData } from './expanded-modal-utils/useProcessBreakdownData';
import { useChartAnimationKeys } from './expanded-modal-utils/useChartAnimationKeys';

const ganttTimelineChartPromise = import('../../timeline/GanttTimelineChart').then((module) => ({ default: module.GanttTimelineChart }));
const donutWorkloadChartPromise = import('../../charts/DonutWorkloadChart').then((module) => ({ default: module.DonutWorkloadChart }));
const userContributionStackChartPromise = import('../../charts/UserContributionStackChart').then((module) => ({ default: module.UserContributionStackChart }));
const processTimeBreakdownChartPromise = import('../../charts/ProcessTimeBreakdownChart').then((module) => ({ default: module.ProcessTimeBreakdownChart }));
