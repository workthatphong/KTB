...
import { useDashboardUICtx } from '@/features/dashboard/contexts/DashboardContext';
import { ChartPanelFallback } from './ChartPanelFallback';

const donutWorkloadChartPromise = import('../../../../charts/DonutWorkloadChart').then((m) => ({ default: m.DonutWorkloadChart }));
